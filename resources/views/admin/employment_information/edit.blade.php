...
<div class="container mt-2">
		@component('components.breadcrumb')
            @slot('title')
                @lang('employment_information.edittitle')
            @endslot
            @slot('breadcrumb1')
	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<h3>@lang('employment_information.edittitle')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('employment_information.update',$data->id) }}" enctype="multipart/form-data">
					@csrf
					@method('PUT')
					<div class="row myinput">
						...
						<div class="form-group mb-3 col-md-6">
							<label>@lang('employment_information.image'):</label>
							<div class="input-group mt-2">
								<input class="form-control" type="file" name="image" id="image">
								<br>
							</div>
							<a href="{{ asset($data->image) }}" download="" class="btn btn-info">@lang('employment_information.download')</a>
						</div>
