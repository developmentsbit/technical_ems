...
<div class="container mt-2">
	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				<h3>@lang('studentproject.addtitle')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('studentproject.store') }}" enctype="multipart/form-data">
					@csrf
					<div class="row myinput">
						...
						<div class="form-group mb-3 col-md-6">
							<label>@lang('studentproject.details_en'): <span class="text-danger" style="font-size: 15px;">*</span></label>
							<div class="input-group mt-2">
						...
						<div class="form-group mb-3 col-md-12">
							<label>@lang('studentproject.image'): <span class="text-danger" style="font-size: 15px;">*</span></label>
							<div class="input-group mt-2">
