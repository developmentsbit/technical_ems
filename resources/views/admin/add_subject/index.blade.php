		...
		<div class="card">
			<div class="card-body">
				...
				<table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
					<thead class="mythead">
						<tr>
							<th>@lang('add_subject.subject_serial_no')</th>
							<th>@lang('add_subject.departmentname')</th>
							<th>@lang('add_subject.semestername')</th>
							<th>@lang('add_subject.name')</th>
							<th>@lang('add_subject.subject_code')</th>
					...
					<tbody class="tbody" id="showtdata">
						...
						<tr id="tr{{ $d->id }}">
							...
							<td>
                                @if($lang == 'en')
                                {{ $d->department ?: $d->department_name_bn}}
                                @else
                                {{$d->department_name_bn ?: $d->department}}
                                @endif
                            </td>

							<td>
                                @if($lang == 'en')
                                {{ $d->semester_name ?: $d->semester_name_bn}}
                                @else
                                {{$d->semester_name_bn ?: $d->semester_name}}
                                @endif
                            </td>
							<td>
                                @if($lang == 'en')
