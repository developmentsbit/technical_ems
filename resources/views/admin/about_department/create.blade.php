...
<div class="container mt-2">
		@component('components.breadcrumb')
            @slot('title')
                @lang('about_department.addtitle')
            @endslot
            @slot('breadcrumb1')
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<h3>@lang('about_department.addtitle')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('about_department.store') }}" enctype="multipart/form-data">
					@csrf
