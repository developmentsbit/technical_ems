...
<div class="content-body">
	<div class="container-fluid mt-3">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">@lang('teacher.managetitle')</h4>
						...
						<table class="table table-striped table-bordered zero-configuration">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a onclick="return confirm('Are you sure?')" href="{{ url("deletecoursematerials/".$d->id) }}" class="btn btn-danger btn-sm">Delete</a>
