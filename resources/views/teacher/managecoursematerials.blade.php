...
<div class="content-body">
	...
	<div class="container-fluid mt-3">
		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Manage Course Materials</h4>
						...
						<table class="table table-striped table-bordered zero-configuration">
							...
							<tbody>
								...
								<tr>
									...
									<td><a onclick="return confirm('Are you sure?')" href="{{ url("deletecoursematerials/".$d->id) }}" class="btn btn-danger btn-sm">Delete</a>
									<a href="{{ url("editcoursematerials/".$d->id) }}" class="btn btn-info btn-sm">Edit</a>
								</td>
								</tr>
