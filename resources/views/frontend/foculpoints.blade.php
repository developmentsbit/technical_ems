                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-12 mt-3" data-aos="fade-right" data-aos-duration="2000">
                                    <table class="table table-bordered " id="studenttable">
                                        ...
                                        <tr>
                                            <td colspan="3"><center><a href="{{ url("focul_point_details",$d->id) }}" class="btn btn-warning text-white btn-sm float-end">@lang('frontend.detail')</a></center></td> 
                                        </tr>               
                                    </table>
