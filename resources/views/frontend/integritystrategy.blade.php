    ...
    <div class="row">
      <div class="col-sm-12 col-12">
        ...
        <ul class="list-group p-0">
          <li class="list-group-item font-weight-bold bg-success text-light" id="about">@lang('frontend.integritystrategy')</li>
              ...
              <table id="example" class="display table-bordered" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr style="font-size: 12px;">
                      ...
                      <td>
                          <a href="{{ url('view_integritystrategy',$d->id) }}" class="btn btn-sm btn-danger" target="_blank"><span uk-icon="icon: file-pdf; ratio: 1"></span>Open</a>
