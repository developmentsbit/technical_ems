    ...
    <div class="col-sm-9 col-12">
      ...
      <ul class="list-group p-0">
        <li class="list-group-item bg-success text-white">
          <span class="student"><span uk-icon="icon: info; ratio: 1.2"></span>&nbsp;&nbsp;@if($lang == 'en'){{ $data->department ?: $data->department_name_bn }}@else {{$data->department_name_bn ?: $data->department}}@endif ডিপার্টমেন্টের বিস্তারিত</span>
        </li>
        <br>
